...
function findWasmBinary() {
  return locateFile('algorithms.wasm');
}
...
var _parseCSV = Module['_parseCSV'] = makeInvalidEarlyAccess('_parseCSV');
...
var _detectPatterns = Module['_detectPatterns'] = makeInvalidEarlyAccess('_detectPatterns');
...
var _extractNTokensString = Module['_extractNTokensString'] = makeInvalidEarlyAccess('_extractNTokensString');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['parseCSV'] != 'undefined', 'missing Wasm export: parseCSV');
  _parseCSV = Module['_parseCSV'] = createExportWrapper('parseCSV', 1);
  assert(typeof wasmExports['detectMissing'] != 'undefined', 'missing Wasm export: detectMissing');
  _detectMissing = Module['_detectMissing'] = createExportWrapper('detectMissing', 1);
  assert(typeof wasmExports['detectDuplicates'] != 'undefined', 'missing Wasm export: detectDuplicates');
  ...
  assert(typeof wasmExports['toUpperCaseString'] != 'undefined', 'missing Wasm export: toUpperCaseString');
  ...
  assert(typeof wasmExports['detectInconsistentValues'] != 'undefined', 'missing Wasm export: detectInconsistentValues');
  ...
  assert(typeof wasmExports['detectPatterns'] != 'undefined', 'missing Wasm export: detectPatterns');
  _detectPatterns = Module['_detectPatterns'] = createExportWrapper('detectPatterns', 1);
  assert(typeof wasmExports['autoDetectAll'] != 'undefined', 'missing Wasm export: autoDetectAll');
  _autoDetectAll = Module['_autoDetectAll'] = createExportWrapper('autoDetectAll', 1);
  assert(typeof wasmExports['measurePerformance'] != 'undefined', 'missing Wasm export: measurePerformance');
  ...
  assert(typeof wasmExports['testStandardize'] != 'undefined', 'missing Wasm export: testStandardize');
  _testStandardize = Module['_testStandardize'] = createExportWrapper('testStandardize', 3);
  assert(typeof wasmExports['removeEmptyRowsString'] != 'undefined', 'missing Wasm export: removeEmptyRowsString');
  ...
  assert(typeof wasmExports['extractNTokensString'] != 'undefined', 'missing Wasm export: extractNTokensString');
  _extractNTokensString = Module['_extractNTokensString'] = createExportWrapper('extractNTokensString', 2);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = AlgorithmsModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = AlgorithmsModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => AlgorithmsModule);
