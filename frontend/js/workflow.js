...
function showFindReplaceOptions(){document.getElementById('clusterReviewSection').style.display='none';document.getElementById('findReplaceSection').style.display='block';}
function finishWorkflow(){const headers=cleanedCSV.trim().split('\n')[0].split(',');updateTableDisplay(headers);document.getElementById('findReplaceSection').style.display='none';}
